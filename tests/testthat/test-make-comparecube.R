...
test_that("make_comparecube works", {
  ...
  invisible(capture.output(expect_no_error(make_comparecube(newcube[AAR == single_aar], oldcube[AAR == single_aar], outliers = F))))
  invisible(capture.output(expect_no_error(make_comparecube(newcube[AAR == single_aar], oldcube[AAR == single_aar], outliers = T))))
